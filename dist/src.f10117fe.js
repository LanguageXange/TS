...
exports.User = User;
},{"./APISync":"src/models/APISync.ts","./Attribute":"src/models/Attribute.ts","./Eventing":"src/models/Eventing.ts","./Model":"src/models/Model.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
